  ...
  return (
    <Screen backgroundColor={colors.surfaceMuted}>
      ...
      <Card style={styles.queueCard}>
        <View style={styles.toolbar}><View style={[styles.search, mobile && styles.searchMobile]}><Field icon="search-outline" value={search} onChangeText={setSearch} placeholder="Cari judul listing, alasan, atau pelapor..." /></View><Text style={styles.queueCount}>{visible.length} laporan</Text></View>
...
const styles = StyleSheet.create({
  ...
  listingRowMobile: { alignItems: 'flex-start' },
  ...
  listingBodyMobile: { minWidth: 0, flexBasis: 170 },
