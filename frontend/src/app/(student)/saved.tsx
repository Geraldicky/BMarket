...
export default function SavedScreen() {
  ...
  const contentWidth = Math.max(288, Math.min(width - 32, layout.contentMaxWidth - 80));
  const columns = contentWidth >= 1040 ? 5 : contentWidth >= 780 ? 4 : contentWidth >= 540 ? 3 : 2;
  const gap = 12;
  ...
  return <Screen style={styles.page}>
    <View style={styles.topRow}>
      ...
      <View style={styles.heading}><Text style={styles.eyebrow}>DISCOVERY</Text><Text style={styles.title}>Tersimpan & terakhir dilihat</Text><Text style={styles.copy}>Simpan listing yang menarik dan lanjutkan pencarian tanpa kehilangan jejak.</Text></View>
    </View>
