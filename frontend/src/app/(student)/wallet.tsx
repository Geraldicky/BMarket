...
export default function WalletScreen(){
  ...
  return <Screen><BackButton desktopOnly /><Title eyebrow="AUDIT SALDO" subtitle="Setiap perubahan saldo dan escrow tercatat di sini.">Riwayat saldo</Title>
