...
import { StyleProp, Text, View, ViewStyle, useWindowDimensions } from 'react-native';
...
export function AdminStatCard({ label, value, color = colors.primary, style }: {
  label: string;
  value: ReactNode;
  caption?: string;
  icon?: IconName;
...
const useStyles = makeStyles(() => ({
  ...
  statCard: { minWidth: 150, flex: 1, gap: 4, padding: 16 },
  statCardMobile: { minWidth: 0, flexBasis: '46%', padding: 14 },
  statLabel: { color: colors.muted, fontFamily: 'PoppinsMedium', fontSize: 12.5 },
  statValue: { fontFamily: 'PoppinsBold', fontSize: 24, lineHeight: 30 },
  ...
  emptyGlow: { width: 86, height: 86, borderRadius: 30, backgroundColor: colors.primaryMist, alignItems: 'center', justifyContent: 'center', marginBottom: 10 },
  emptyIcon: { width: 58, height: 58, borderRadius: 18, backgroundColor: colors.primarySoft, borderWidth: 1, borderColor: colors.primaryBorder, alignItems: 'center', justifyContent: 'center' },
